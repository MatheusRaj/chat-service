...
var DelayQueue = /** @class */ (function (_super) {
    ...
    function DelayQueue(connection, name) {
    ...
    DelayQueue.prototype.durable = function (durable) {
        if (durable === void 0) { durable = true; }
        this.options.durable = durable;
        return this;
    };
    DelayQueue.prototype.timeout = function (value) {
        this.options.timeout = value;
        return this;
    };
    DelayQueue.prototype.from = function (topic) {
        this.options.fromTopic = topic;
        return this;
    };
    DelayQueue.prototype.to = function (topic) {
        this.options.toTopic = topic;
        return this;
    };
    DelayQueue.prototype.create = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ch, exchange, args;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, ch.bindQueue(this.options.name, exchange, this.options.fromTopic)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
