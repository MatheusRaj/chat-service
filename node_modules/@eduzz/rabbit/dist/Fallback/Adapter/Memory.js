...
var Memory = /** @class */ (function () {
    function Memory(maxItems) {
        if (maxItems === void 0) { maxItems = Number.MAX_SAFE_INTEGER; }
        this.maxItems = maxItems;
        this.buffer = [];
    }
    Memory.prototype.store = function (topic, message) {
    ...
    Memory.prototype.setConnection = function (connection) {
        var _this = this;
        clearInterval(this.interval);
        var working = false;
        this.interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            var length, data, publishers, _i, publishers_1, publisher;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        data = this.buffer.splice(0, 1)[0];
                        publishers = connection.getPublishersByTopic(data.topic);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, publisher.send(data.message)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
